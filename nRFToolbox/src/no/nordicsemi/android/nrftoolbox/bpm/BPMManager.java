...
public class BPMManager {
	...
	private BluetoothGattCharacteristic mBPMCharacteristic, mICPCharacteristic, mBatteryCharacteritsic;
	...
	private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
		...
		public void onServicesDiscovered(final BluetoothGatt gatt, final int status) {
			if (status == BluetoothGatt.GATT_SUCCESS) {
				...
				mCallbacks.onServicesDiscovered(mBPMCharacteristic != null, mICPCharacteristic != null, mBatteryCharacteritsic != null);
				...
				Logger.e(TAG, "onServicesDiscovered error " + status);
		...
		private void readBatteryLevel(final BluetoothGatt gatt) {
			Logger.d(TAG, "readBatteryLevel()");
			gatt.readCharacteristic(mBatteryCharacteritsic);
		}
	};
	...
	private void enableIntermediateCuffPressureNotification(final BluetoothGatt gatt) {
		Logger.d(TAG, "enableIntermediateCuffPressureNotification()");
	...
	private void enableBloodPressureMeasurementIndication(final BluetoothGatt gatt) {
		Logger.d(TAG, "enableBloodPressureMeasurementIndication()");
